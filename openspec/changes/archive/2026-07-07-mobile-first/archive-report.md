...
| Archive | ✅ Done | archive-report.md | All artifacts moved, specs synced, state updated |
...
**Archive Path**: `openspec/changes/archive/2026-07-07-mobile-first/`  
**Active Changes Dir**: Clean (mobile-first folder moved to archive)
